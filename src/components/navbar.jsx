...
import { clearUserSession } from "../core/utils";
        ...
        >
          {user === null ? (
            ...
            <>
              ...
              <NavLink
                to={user === "customer" ? "/dashboard" : "/chef-dashboard"}
                className={({ isActive }) =>
                  `text-base sm:text-lg ${
                    isActive
                      ? "text-orange-600 font-semibold"
              ...
              <div
                ...
                className="text-base cursor-pointer sm:text-lg text-gray-600 hover:text-orange-600 font-semibold mb-2 sm:mb-0"
              >
                Logout
              </div>
            </>
